...
namespace LightSide
{
    ...
    internal static class Reseter
    {
        ...
        /// <summary>True from the moment beforeAssemblyReload fires until the domain is unloaded.
        /// Prevents any work in OnWillRenderCanvases after native resources are freed.</summary>

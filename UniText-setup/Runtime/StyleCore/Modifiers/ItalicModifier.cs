...
namespace LightSide
{
    ...
    /// </summary>
    /// <remarks>
    /// No parameter. The italic effect is achieved by horizontally shearing the glyph vertices.
    /// The shear angle is determined by the font's ItalicStyle property (default 12 degrees).
    /// </remarks>
    [Serializable]
    [TypeGroup("Text Style", 0)]
    [TypeDescription("Applies italic style by slanting glyphs.")]

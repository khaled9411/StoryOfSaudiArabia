...
namespace LightSide
{
    ...
    public abstract class InteractiveModifier : BaseModifier, IInteractiveRangeHandler
    {
        ...
        /// <summary>Gets or sets the per-modifier text highlighter. When null, the global UniText highlighter is used as fallback.</summary>
        public TextHighlighter Highlighter
        {
            ...
            set
            {
                ...
                highlighter?.Destroy();
                highlighter = value;
                if (uniText is UniText owner)
                    highlighter?.Initialize(owner);
            }
        }
        ...
        protected override void OnEnable()
        {
            ...
            if (highlighter != null && uniText is UniText owner)
                highlighter.Initialize(owner);
        }

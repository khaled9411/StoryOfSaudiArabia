...
namespace LightSide
{
    ...
    public abstract class BaseModifier
    {
        ...
        /// <summary>Subscribes to UniText events. Override to set up buffers and event handlers.</summary>
        protected virtual void OnEnable() { }

        /// <summary>Unsubscribes from UniText events. Override to remove event handlers.</summary>
        protected virtual void OnDisable() { }

        /// <summary>Releases buffers when the modifier is removed. Override to clean up resources.</summary>

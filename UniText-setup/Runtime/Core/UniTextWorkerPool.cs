...
namespace LightSide
{
    ...
    internal static class UniTextWorkerPool
    {
        ...
        private static UniTextBase[] currentComponents;
        private static int currentComponentCount;
        private static Action<UniTextBase> currentAction;
        ...
        public static void Execute(UniTextBase[] components, int count, Action<UniTextBase> action)
        {
            if (count == 0) return;

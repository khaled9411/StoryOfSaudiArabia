...
namespace LightSide
{
    ...
    public sealed class UniTextBuffers
    {
        ...
        /// <summary>Maps variation fontId → axis info for variable font runs. Set by TextProcessor.ResolveVariableAxes.</summary>
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal long ResolveVarHash48(int fontId, UniTextFont font)
        {
        ...
        /// <summary>Variation configs written by VariationModifier, read by TextProcessor.ResolveVariableAxes.</summary>
        internal PooledBuffer<VariationModifier.VariationConfig> variationConfigs;
        ...
        /// <summary>
        /// Gets or creates a <see cref="PooledArrayAttribute{T}"/> and clears it to codepoint count.
        /// Combines GetOrCreateAttributeData + EnsureCountAndClear into a single call.
        /// </summary>
        public void PrepareAttribute<T>(ref PooledArrayAttribute<T> attribute, string key) where T : unmanaged
        {
            ...
            attribute.EnsureCountAndClear(codepoints.count);
        }

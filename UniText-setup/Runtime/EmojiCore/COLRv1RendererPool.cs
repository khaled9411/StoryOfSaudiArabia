...
namespace LightSide
{
    ...
    internal sealed class COLRv1RendererPool : IDisposable
    {
        ...
        public COLRv1RendererPool(byte[] fontData, int faceIndex, int maxRenderers = 0)
        {
            ...
            availableRenderers = new ConcurrentBag<COLRv1Renderer>();
            allRenderers = new List<COLRv1Renderer>(this.maxRenderers);
        }
        ...
        public RenderedGlyph[] RenderGlyphsBatch(PooledBuffer<uint> glyphIndices, int pixelSize)
        {
        ...
        private void RenderSequential(PooledBuffer<uint> glyphIndices, int pixelSize, RenderedGlyph[] results)
        {
        ...
        private void RenderParallel(PooledBuffer<uint> glyphIndices, int pixelSize, RenderedGlyph[] results)
        {
            int count = glyphIndices.count;

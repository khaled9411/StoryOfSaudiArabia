...
| | |
|---|---|
| **Non-commercial use** | **Free.** Personal projects, learning, research, game jams, open-source, education, non-profits — go ahead. |
| **Commercial use** | **Requires a commercial license.** If your project generates revenue or is part of a commercial product, you need a separate license. |
...
Copyright (c) 2026 Light Side LLC
...
Required Notice: Copyright (c) 2026 Light Side LLC (https://unity.lightside.media)
